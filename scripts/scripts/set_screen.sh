...
two() {
    ...
    xrandr --output $INNER_PORT --mode 2560x1600 --pos 0x0 --dpi 100 -r 165 &&
    xrandr --output $OUTPORT_CONNECTED --mode 1920x1080 --pos 2560x0 -r 144 --primary &&
    xrandr --output $OUTPORT_DISCONNECTED --off
    feh --randomize --bg-fill ~/Pictures/wallpaper/
}
one() {
    xrandr --output $INNER_PORT --mode 2560x1600 --pos 0x0 --dpi 100 -r 165 --primary &&
    xrandr --output $OUTPORT1 --off &&
    xrandr --output $OUTPORT2 --off &&
    feh --randomize --bg-fill ~/Pictures/wallpaper/
}
check() {
