...
HEADLINE_HOST_CMD='hostname' # consider 'basename "$VIRTUAL_ENV"' to replace host with environment
...
HEADLINE_CLOCK_FORMAT='%Y-%m-%d %A %p%l:%M:%S %Z' # consider "%+" for full date (see man strftime)
